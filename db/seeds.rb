...
story_5_parts = [
  'He groped for a while in the darkness and when the lights came back on he found himself on the third floor. This particular skill,',
  'apparently unrelated to any aspiration of his, rather disturbed him. He felt within him a need for expansion, a growing desire to fulfil',
  'and surpass himself, a stab of longing which was something like a call of what lay through the wall. Unfortunately, he lacked an objective.',
  'He looked for inspiration in the newspaper, particularly in the politics activities, but finally in realising that they offered no outlets',
  'he made do with the most promising of the ‘brief’ news items. His eyes shone with warmth and gratitude.',
...
11.times do |i|
  ...
  user.photo_url = 'http://placehold.it/150x150'
  user.save
  users << user
end
